...
import '../../theme/oe_font_family.dart';
import '../../theme/oe_fonts.dart';
import '../../theme/oe_radius.dart';
import '../../theme/oe_spacers.dart';
import '../../theme/oe_theme.dart';
import '../input/input_view.dart';
import '../input/oe_input.dart';
import '../text/oe_text.dart';

enum OeTextareaLayout { vertical, horizontal }

/// 用于多行文本信息输入
class OeTextarea extends StatefulWidget {
  const OeTextarea({
    Key? key,
    this.width,
    this.textStyle,
    ...
    this.layout = OeTextareaLayout.horizontal,
    this.autosize,
    this.labelIcon,
    this.labelWidth,
    this.margin,
  ...
  @override
  _OeTextareaState createState() => _OeTextareaState();
}

class _OeTextareaState extends State<OeTextarea> {
  ...
  Widget _getLabelView(BuildContext context) {
    var padding = _getInputPadding(context);
    var isHorizontal = widget.layout == OeTextareaLayout.horizontal;
    var fontSize = isHorizontal
        ? OeTheme.of(context).fontBodyLarge?.size
        : OeTheme.of(context).fontBodyMedium?.size;
    ...
    return Container(
      ...
      padding: isHorizontal
          ...
          : EdgeInsets.only(bottom: OeTheme.of(context).spacer8),
      child: Row(
        ...
        children: [
          ...
          widget.required == true
              ? Padding(
                  padding: EdgeInsets.only(left: OeTheme.of(context).spacer4),
                  child: OeText(
                    '*',
                    style: TextStyle(
  ...
  double _getInputPadding(BuildContext context) {
    switch (widget.size) {
      case OeInputSize.small:
        return OeTheme.of(context).spacer12;
      case OeInputSize.large:
        return OeTheme.of(context).spacer16;
      default:
        return OeTheme.of(context).spacer16;
    }
  }
