...
class OeCupertinoActivityIndicator extends StatefulWidget {
  /// Creates an iOS-style activity indicator that spins clockwise.
  const OeCupertinoActivityIndicator({
    Key? key,
    this.animating = true,
  ...
  @override
  _OeCupertinoActivityIndicatorState createState() =>
      _OeCupertinoActivityIndicatorState();
}

class _OeCupertinoActivityIndicatorState
    extends State<OeCupertinoActivityIndicator>
  ...
  @override
  void didUpdateWidget(OeCupertinoActivityIndicator oldWidget) {
