...
class OeCircleIndicator extends StatefulWidget {
  const OeCircleIndicator({
    Key? key,
    this.color,
    this.size = 20.0,
    this.lineWidth = 3.0,
  ...
  @override
  _OeCircleIndicatorState createState() => _OeCircleIndicatorState();
}

class _OeCircleIndicatorState extends State<OeCircleIndicator>
  ...
  @override
  void didUpdateWidget(covariant OeCircleIndicator oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    var paintColor = widget.color ?? OeTheme.of(context).brandNormalColor;
    return Transform(
