...
class OeCalendarCell extends StatefulWidget {
  const OeCalendarCell({
    Key? key,
    this.tdate,
    this.format,
    required this.type,
  ...
  final double height;
  final Map<DateTime, List<Oeate?>> data;
  final double padding;
  final int rowIndex;
  final int colIndex;
  final List<Oeate?> dateList;

  @override
  _OeCalendarCellState createState() => _OeCalendarCellState();
}

class _OeCalendarCellState extends State<OeCalendarCell> {
  var isToday = false;
  ...
  @override
  void didUpdateWidget(OeCalendarCell oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final cellStyle = OeCalendarStyle.cellStyle(context, widget.tdate!._type);
  ...
  Color? _getColor(OeCalendarStyle cellStyle, BoxDecoration? decoration) {
    positionOffset = 0;
    final next = _nextDay();
