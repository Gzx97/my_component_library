...
class OeSliderThemeData {
  ...
  OeSliderThemeData({
    ...
    SliderThemeData? sliderThemeData,
            ...
            TextStyle(fontSize: 14, color: OeTheme.of(context).fontGyColor1),
        disabledScaleTextStyle = disabledScaleTextStyle ??
            TextStyle(fontSize: 14, color: OeTheme.of(context).fontGyColor4),
  ...
  SliderThemeData normal() {
    return SliderThemeData(
      trackHeight: 4,
      activeTrackColor: OeTheme.of(context).brandNormalColor,
      inactiveTrackColor: OeTheme.of(context).grayColor4,
      disabledActiveTrackColor: OeTheme.of(context).brandDisabledColor,
      disabledInactiveTrackColor: OeTheme.of(context).grayColor2,
      activeTickMarkColor: OeTheme.of(context).brandNormalColor,
      inactiveTickMarkColor: OeTheme.of(context).grayColor4,
      disabledActiveTickMarkColor: OeTheme.of(context).brandDisabledColor,
      disabledInactiveTickMarkColor: OeTheme.of(context).grayColor2,
      thumbColor: Colors.white,
      disabledThumbColor: Colors.white,
      overlayShape: const OeNoOverlayShape(),
      tickMarkShape: OeRoundSliderTickMarkShape(themeData: this),
      thumbShape: OeRoundSliderThumbShape(themeData: this),
      trackShape: OeRoundedRectSliderTrackShape(themeData: this),
      rangeTickMarkShape: OeRoundRangeSliderTickMarkShape(themeData: this),
      rangeThumbShape: OeRoundRangeSliderThumbShape(themeData: this),
      rangeTrackShape: OeRoundedRectRangeSliderTrackShape(themeData: this),
  ...
  SliderThemeData capsule() {
    return SliderThemeData(
      trackShape: OeCapsuleRectSliderTrackShape(themeData: this),
      tickMarkShape: OeCapsuleSliderTickMarkShape(themeData: this),
      thumbShape: OeCapsuleSliderThumbShape(themeData: this),
      rangeTrackShape: OeCapsuleRectRangeSliderTrackShape(themeData: this),
      rangeTickMarkShape: OeCapsuleRangeSliderTickMarkShape(themeData: this),
      rangeThumbShape: OeCapsuleRangeSliderThumbShape(themeData: this),
      activeTickMarkColor: OeTheme.of(context).grayColor3,
      inactiveTickMarkColor: OeTheme.of(context).grayColor3,
      disabledActiveTickMarkColor: OeTheme.of(context).grayColor3,
      disabledInactiveTickMarkColor: OeTheme.of(context).grayColor3,
      thumbColor: Colors.white,
      disabledThumbColor: Colors.white,
      trackHeight: 24,
      activeTrackColor: OeTheme.of(context).brandNormalColor,
...
///Slider轨道绘制
///
class OeRoundedRectSliderTrackShape extends SliderTrackShape
    with BaseSliderTrackShape {
  /// Create a slider track that draws two rectangles with rounded outer edges.
  const OeRoundedRectSliderTrackShape({required this.themeData});

  final OeSliderThemeData themeData;
...
///游标的绘制
///
class OeRoundSliderThumbShape extends SliderComponentShape {
  /// Create a slider thumb that draws a circle.
  const OeRoundSliderThumbShape({
  ...
  void paint(
    ...
    canvas.drawArc(
        ...
        Paint()
          ...
          ..strokeWidth = 1
          ..color = OeTheme.of().grayColor3);
  }
}

///系统用于绘制Overlay，这里不做绘制，只做slider的宽高计算
class OeNoOverlayShape extends SliderComponentShape {
  const OeNoOverlayShape();
...
/// 刻度绘制
///
class OeRoundSliderTickMarkShape extends SliderTickMarkShape {
  /// Create a slider tick mark that draws a circle.
  const OeRoundSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///    rectangular edges
mixin OeBaseRangeSliderTrackShape {
...
/// The default shape of a [OeRangeSlider]'s track.
///
...
class OeRoundedRectRangeSliderTrackShape extends RangeSliderTrackShape
    with OeBaseRangeSliderTrackShape {
  ...
  const OeRoundedRectRangeSliderTrackShape({required this.themeData});
...
class OeRoundRangeSliderThumbShape extends RangeSliderThumbShape {
  /// Create a slider thumb that draws a circle.
  const OeRoundRangeSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 3.0,
...
class OeRoundRangeSliderTickMarkShape extends RangeSliderTickMarkShape {
  /// Create a range slider tick mark that draws a circle.
  const OeRoundRangeSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///Slider轨道绘制
///
class OeCapsuleRectSliderTrackShape extends SliderTrackShape
    with BaseSliderTrackShape, OeCapsuleTrackShape {
  /// Create a slider track that draws two rectangles with rounded outer edges.
  const OeCapsuleRectSliderTrackShape(
...
///游标的绘制
///
class OeCapsuleSliderThumbShape extends SliderComponentShape {
  /// Create a slider thumb that draws a circle.
  const OeCapsuleSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 4.0,
    this.pressedElevation = 4.0,
...
/// 刻度绘制
///
class OeCapsuleSliderTickMarkShape extends SliderTickMarkShape {
  /// Create a slider tick mark that draws a circle.
  const OeCapsuleSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
...
///    the [RangeSlider]'s track.
///  * [RectangularRangeSliderTrackShape], for a similar track with sharp edges.
class OeCapsuleRectRangeSliderTrackShape extends RangeSliderTrackShape
    with OeBaseRangeSliderTrackShape {
  final Color trackColorWhenShowScale;
  ...
  /// The middle track segment is the selected range and is active, and the two
  /// outer track segments are inactive.
  const OeCapsuleRectRangeSliderTrackShape(
      {this.trackColorWhenShowScale = const Color(0xFFE7E7E7),
      required this.themeData});
...
///  * [SliderTheme], which can be used to configure the thumb shapes of all
///    range sliders in a widget subtree.
class OeCapsuleRangeSliderThumbShape extends RangeSliderThumbShape {
  /// Create a slider thumb that draws a circle.
  const OeCapsuleRangeSliderThumbShape({
    this.enabledThumbRadius = 10.0,
    this.disabledThumbRadius,
    this.elevation = 3.0,
    this.pressedElevation = 3.0,
...
///  * [SliderTheme], which can be used to configure the tick mark shape of all
///    sliders in a widget subtree.
class OeCapsuleRangeSliderTickMarkShape extends RangeSliderTickMarkShape {
  /// Create a range slider tick mark that draws a circle.
  const OeCapsuleRangeSliderTickMarkShape({
    this.tickMarkRadius,
    required this.themeData,
  });
