...
import 'oe_slider_theme.dart';

/// 单滑动选择器
class OeSlider extends StatefulWidget {
  /// 默认值
  final double value;
  ...
  /// 样式
  final OeSliderThemeData? sliderThemeData;
  ...
  State<StatefulWidget> createState() {
    return OeSliderState();
  }
}

class OeSliderState extends State<OeSlider> {
  double value = 0;
  ...
  @override
  void didUpdateWidget(covariant OeSlider oldWidget) {
  ...
  Widget build(BuildContext context) {
    var tdSliderThemeData = widget.sliderThemeData ?? OeSliderThemeData();
    return Container(
...
/// 范围滑动选择器
class OeRangeSlider extends StatefulWidget {
  /// 默认值
  ...
  @override
  State<StatefulWidget> createState() {
    return _OeRangeSliderState();
  }
}

class _OeRangeSliderState extends State<OeRangeSlider> {
  ...
  @override
  void didUpdateWidget(covariant OeRangeSlider oldWidget) {
    super.didUpdateWidget(oldWidget);
    rangeValues = widget.value;
  }
