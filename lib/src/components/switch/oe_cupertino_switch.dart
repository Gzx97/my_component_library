...
///
/// {@tool dartpad}
/// This example shows a toggleable [OeCupertinoSwitch]. When the thumb slides to
...
/// {@tool snippet}
///
/// This sample shows how to use a [OeCupertinoSwitch] in a [ListTile]. The
...
class OeCupertinoSwitch extends StatefulWidget {
  ...
  /// {@template flutter.cupertino.OeCupertinoSwitch.dragStartBehavior}
  ...
  @override
  State<OeCupertinoSwitch> createState() => _OeCupertinoSwitchState();
...
class _OeCupertinoSwitchState extends State<OeCupertinoSwitch>
  ...
  @override
  void didUpdateWidget(OeCupertinoSwitch oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: Opacity(
        opacity:
            widget.onChanged == null ? _kOeCupertinoSwitchDisabledOpacity : 1.0,
        child: _OeCupertinoSwitchRenderObjectWidget(
          value: widget.value,
...
class _OeCupertinoSwitchRenderObjectWidget
    extends SingleChildRenderObjectWidget {
  const _OeCupertinoSwitchRenderObjectWidget({
    required this.child,
    required this.value,
  ...
  final Color thumbColor;
  final ValueChanged<bool>? onChanged;
  final _OeCupertinoSwitchState state;
  ...
  @override
  _RenderOeCupertinoSwitch createRenderObject(BuildContext context) {
    return _RenderOeCupertinoSwitch(
      value: value,
  ...
  void updateRenderObject(
      BuildContext context, _RenderOeCupertinoSwitch renderObject) {
    renderObject
      ..value = value
      ..activeColor = activeColor
      ..trackColor = trackColor
...
const double _kOeCupertinoSwitchDisabledOpacity = 0.5;
...
class _RenderOeCupertinoSwitch extends RenderConstrainedBox {
  _RenderOeCupertinoSwitch({
    required bool value,
    ...
    required _OeCupertinoSwitchState state,
  })  : _value = value,
  ...
  final _OeCupertinoSwitchState _state;
