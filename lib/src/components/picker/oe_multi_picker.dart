...
/// 项之间无联动的多项选择器
class OeMultiPicker extends StatelessWidget {
  /// 选择器标题
  final String? title;
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(
              topRadius ?? OeTheme.of(context).radiusExtraLarge),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.all(Radius.circular(
                              OeTheme.of(context).radiusDefault))),
                    ),
              ),
              // 列表
              Container(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          OeTheme.of(context).whiteColor1.withOpacity(0)
                        ])),
                  ),
                ),
              ),
  ...
  Widget buildTitle(
      BuildContext context, List<FixedExtentScrollController> controllers) {
    return Container(
        ...
        children: [
          ...
          GestureDetector(
              ...
              child: OeText(
                ...
                style: leftTextStyle ??
                    TextStyle(
                        fontSize: OeTheme.of(context).fontBodyLarge!.size,
                ...
                : Center(
                    child: OeText(
                      ...
                      style: centerTextStyle ??
                          TextStyle(
                              fontSize:
                                  OeTheme.of(context).fontTitleLarge!.size,
  ...
  Widget buildList(
      context, int position, List<FixedExtentScrollController> controllers) {
    var maxWidth = MediaQuery.of(context).size.width;
...
/// 多项联动选择器
class OeMultiLinkedPicker extends StatefulWidget {
  /// 选择器标题
  final String? title;
  ...
  @override
  State<StatefulWidget> createState() => _OeMultiLinkedPickerState();
}

class _OeMultiLinkedPickerState extends State<OeMultiLinkedPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.only(
          topLeft: Radius.circular(
              widget.topRadius ?? OeTheme.of(context).radiusExtraLarge),
          topRight: Radius.circular(
              widget.topRadius ?? OeTheme.of(context).radiusExtraLarge),
        ),
      ),
...
class MultiLinkedPickerModel {
  ...
  void refreshPresentDataAndController(
      int position, int selectedIndex, bool jump) {
    // 新选中的数据
