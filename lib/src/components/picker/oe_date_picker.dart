...
/// 时间选择器
class OeDatePicker extends StatefulWidget {
  const OeDatePicker(
      {required this.title,
  ...
  @override
  State<StatefulWidget> createState() => _OeDatePickerState();
}

class _OeDatePickerState extends State<OeDatePicker> {
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
              ...
              child: OeText(widget.leftText ?? context.resource.cancel,
