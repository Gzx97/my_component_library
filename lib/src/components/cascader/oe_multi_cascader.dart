...
class OeMultiCascader extends StatefulWidget {
  /// 选择器标题
  final String? title;
  ...
  @override
  State<OeMultiCascader> createState() => _OeMultiCascaderState();
}

class _OeMultiCascaderState extends State<OeMultiCascader>
                    ...
                    child: Padding(
                      ...
                      child: widget.closeText == null
                          ...
                          : OeText(
                              ...
                              style: TextStyle(
                                  fontSize:
                                      OeTheme.of(context).fontTitleMedium!.size,
                                  color: OeTheme.of(context).fontGyColor1),
                            ),
                    ),
                  ))),
  ...
  Widget _buildStepBox(BuildContext context) {
    ...
    return Container(
        decoration: BoxDecoration(
            border: Border(
                bottom: BorderSide(
                    color: Color.fromRGBO(0, 0, 0, 0.1), width: 0.5))),
  ...
  Widget _buildTabBox(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          border: Border(
              bottom:
                  BorderSide(color: Color.fromRGBO(0, 0, 0, 0.1), width: 0.5))),
      width: maxWidth,
      child: OeCustomTab(
    ...
    return Container(
      ...
      child: CustomPaint(
        painter: LeftLinePainter(
            ...
            topLineColor: topLineColor ?? OeTheme.of(context).brandNormalColor,
