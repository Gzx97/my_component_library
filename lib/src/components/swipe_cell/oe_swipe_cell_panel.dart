...
class OeSwipeCellPanel {
  ...
  /// 操作组件列表
  final List<OeSwipeCellAction> children;

  /// 二次确认操作组件列表
  final List<OeSwipeCellAction>? confirms;

  /// 是否可通过拖动操作来移除 [OeSwipeCell] 组件
    ...
    return ActionPane(
      ...
      dismissible: _dragDismissible
          ? DismissiblePane(
              ...
              onDismissed: () async {
                await OeSwipeCell.of(context)?.close();
