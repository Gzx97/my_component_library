...
class OeNoticeBar extends StatefulWidget {
  const OeNoticeBar({
    super.key,
    this.context,
    this.style,
    ...
    this.theme = OeNoticeBarTheme.info,
    this.prefixIcon,
    this.suffixIcon,
    this.onTap,
    this.height = 22,
  ...
  @override
  State<StatefulWidget> createState() => _OeNoticeBarState();
}

class _OeNoticeBarState extends State<OeNoticeBar> {
  ScrollController? _scrollController;
  Timer? _timer;
  Size? _size;
  OeNoticeBarStyle? _style;
  ...
  void _init() {
    if (widget.style != null) {
      ...
      _style = OeNoticeBarStyle.generateTheme(context, theme: widget.theme);
    }
