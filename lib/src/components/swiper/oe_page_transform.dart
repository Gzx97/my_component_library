...
/// Oe默认PageTransformer
class OePageTransformer extends PageTransformer {
  /// 缩放比例
  final double? scale;
  ...
  /// 普通margin的卡片式
  OePageTransformer.margin({this.margin = 6.0})
      : fade = 1,
        scale = 1;

  /// 缩放或透明的卡片式
  OePageTransformer.scaleAndFade({this.fade = 1, this.scale = 0.8})
      : margin = 0.0;

  OePageTransformer({this.fade, this.scale, this.margin});
