...
import 'oe_wrap_sidebar_item.dart';
...
class OeSideBar extends StatefulWidget {
  const OeSideBar({
    Key? key,
    this.value,
    this.defaultValue,
    ...
    this.style = OeSideBarStyle.normal,
    this.loading,
    this.loadingWidget,
  ...
  /// 单项
  final List<OeSideBarItem> children;
  ...
  /// 控制器
  final OeSideBarController? controller;
  ...
  @override
  State<OeSideBar> createState() => _OeSideBarState();
}

class _OeSideBarState extends State<OeSideBar> {
  ...
  Widget build(BuildContext context) {
    if (_loading) {
      ...
      return SizedBox(
        ...
        child: const Align(
          child:
              OeLoading(icon: OeLoadingIcon.circle, size: OeLoadingSize.large),
        ),
      );
    }
