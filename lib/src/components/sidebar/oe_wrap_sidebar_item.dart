...
class OeWrapSideBarItem extends StatelessWidget {
  const OeWrapSideBarItem({
    Key? key,
    this.badge,
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: style == OeSideBarStyle.normal
          ...
          Container(
            ...
            decoration: BoxDecoration(
                color: selectedTextStyle != null
                    ...
                    : (selectedColor ?? OeTheme.of(context).brandNormalColor),
